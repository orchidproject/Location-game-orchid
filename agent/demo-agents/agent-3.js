...
function mainloop(){    
    ...
    helper.pointSet.t5, helper.pointSet.p0, //get t5
    helper.pointSet.p4,helper.pointSet.t4, helper.pointSet.p4,helper.pointSet.p0,helper.pointSet.p1 //get t4
    ];
...
function updateTruckLocation(){
    socket.emit('location-push',{"player_id":helper.player.user_id,"latitude":helper.player.lat,"longitude":helper.player.lng,"initials": "AA" ,"skill":helper.player.skill});
}
