...
function mainloop(){    
    ...
    var path=[helper.player,{lat:52.9529583,lng:-1.186727},{lat:52.9540927,lng:-1.18750480},{lat:52.9531411,lng:-1.18569}];
    var section=0;
...
//join game
helper.join('agent','a@agent.com','truck',4,'DD', function(p){
