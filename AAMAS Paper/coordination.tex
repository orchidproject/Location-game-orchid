...
\noindent The computation of values  $v(C_{jk})$ for each coalition $C_{jk}$
...
and has been shown to be efficient for large
MDPs~\cite{kocsis2006bandit}. After $N$ simulations, the averaged
value is returned as an approximation of the coalition value (Line
10).
...
\subsubsection{Adapting to Responders}\label{sec:adaptive}
