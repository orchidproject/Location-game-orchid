...
For example, given that wind speed or the direction of wind
...
team $C_k$ in performing task $t_j$ and is computed from the estimated rewards the team obtains for performing $t_j$ (as we show below).  Then, the goal of the task
...
one allocation (there are usually more targets than responders) and
