  ...
  get '/admin/games/:layer_id/start' do
    ...
    if game.is_active!= -1
		...
		if $game_area_top_left[game.layer_id] == nil
        	$simulations[game.layer_id] = Simulation.new("simulation_data_01.txt", DEFAULT_SIM_LAT, DEFAULT_SIM_LNG, 8, Time.now, 0.2) #last para in mins
        else
        	$simulations[game.layer_id] = Simulation.new("simulation_data_01.txt", 
