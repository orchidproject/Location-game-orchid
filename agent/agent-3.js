...
function mainloop(){    
    ...
    //set initial postion
    helper.player.lat=52.954408;
    helper.player.lng=-1.1862479;
                

    //move a truck along a path
    var path=[helper.player,{lat:52.9542228,lng:-1.1877573},{lat:52.9536905,lng:-1.1885117},{lat:52.9542228,lng:-1.1877573},{lat:52.954408,lng:-1.1862479}];
    var section=0;
