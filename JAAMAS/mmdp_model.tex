...
\todo{FENG: Please add details that you omitted to reduce space requirements}
...
\todo{ the value function in equation (1) is never defined precisely, so it is impossible to determine whether the function to be maximized aligns with the needs of the task}
